import { Box, Card, Chip, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TableSortLabel, Typography } from '@mui/material';
...
const Designation = () => {
  const { designationData, editDesignationId, open, setOpen, scroll, handleClickOpen, handleClose, addDesignation, updateDesignationStatus } = useDesignationData();
  ...
  return (
    <>
      ...
      <DesignationModal editDesignationId={editDesignationId} designationData={designationData} open={open} setOpen={setOpen} scroll={scroll} handleClickOpen={handleClickOpen} handleClose={handleClose} addDesignation={addDesignation} />
