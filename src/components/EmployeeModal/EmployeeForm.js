...
const EmployeeForm = ({ handleClose, editEmployeeId, setOpen, employeeData, addEmployee, editEmployee }) => {
  const { formData, handleInputChange, handleImageChange, errors, validateForm, setFormData, initialFormValue, fetchDepartment, fetchDesignation, departmentData, designationData, fetchRole, roleData } = EmployeeModalLogic(employeeData, editEmployeeId);
  ...
  const handleFormSubmit = async (event) => {
    ...
    const adminToSubmit = { ...formData, department: departmentData.find((d) => d.departmentName === formData.department)?.id };
            ...
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={handleInputChange}
                />
                {errors.mobileNo && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.mobileNo}</Typography>}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
              ...
              {!isInEditMode && (
                <>
                  <Grid item xs={12} sm={6}>
                    ...
                    />
                    {errors.birthDate && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.birthDate}</Typography>}
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      fullWidth
                    ...
                    />
                    {errors.joiningDate && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.joiningDate}</Typography>}
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <FormControl fullWidth>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={handleInputChange}
                />
                {errors.bankAccountHolderName && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.bankAccountHolderName}</Typography>}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  ...
                  onChange={handleInputChange}
                />
                {errors.bankAccountNumber && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.bankAccountNumber}</Typography>}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  ...
                  onChange={handleInputChange}
                />
                {errors.bankName && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.bankName}</Typography>}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  ...
                  onChange={handleInputChange}
                />
                {errors.bankIFSCCode && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.bankIFSCCode}</Typography>}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  ...
                  onChange={handleInputChange}
                />
                {errors.bankBranchLocation && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.bankBranchLocation}</Typography>}
              </Grid>
              <Grid item xs={12} sm={12}>
                <div
                ...
                {errors.governmentDocument && <Typography sx={{ color: "#FF4433", fontSize: "13px", fontWeight: "lighter", pt: 1 }}>{errors.governmentDocument}</Typography>}
              </Grid>
            </Grid>
          </CardContent>
          <Divider sx={{ margin: 0 }} />
