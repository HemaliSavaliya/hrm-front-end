      ...
      <DialogContent dividers>
        ...
        >
            ...
            {fileData ? (
              fileType === 'pdf' ? (
                <object
                  ...
                  style={{ border: 'none' }}
                >
                  <Box>Your browser does not support PDFs. Please download the PDF to view it: <a href={fileData}>Download PDF</a></Box>
                </object>
              ) : fileType === 'png' || fileType === 'jpeg' || fileType === 'jpg' ? (
                <Image width={550} height={300} src={fileData} alt="Image"/>
              ) : fileType === 'pptx' || fileType === 'docx' || fileType === 'xlsx' ? (
                <>
                  <Box>To view the document, download it using the link below and open it using the appropriate application.</Box>
                  <Button
                    variant="outlined"
                    color="primary"
                    href={fileData}
          ...
          <CardActions>
            ...
            <Button size='large' color='secondary' variant='outlined' onClick={onClose} sx={{ lineHeight: 0, padding: "20px 25px !important" }}>
              Cancel
            </Button>
          </CardActions>
        </Box>
