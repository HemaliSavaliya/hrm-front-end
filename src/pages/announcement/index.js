...
const Announcement = () => {
  const { announcementData, editAnnoId, open, setOpen, scroll, handleClickOpen, handleClose, handleEdit, deleteAnnouncement, addAnnouncement, editAnnouncement, deleteDocumentData } = useAnnouncementData();
